...
(custom-set-variables
 ...
 '(elpy-default-minor-modes (quote (eldoc-mode yas-minor-mode auto-complete-mode autopair-mode)))
 '(elpy-rpc-backend "jedi")
 '(elpy-rpc-project-specific nil)
 '(elpy-rpc-python-command "/home/warchiefx/.virtualenvs/emacs/bin/python")
 '(exec-path (quote ("/usr/local/sbin" "/usr/local/bin" "/usr/bin" "/opt/java/bin" "/opt/java/db/bin" "/opt/java/jre/bin" "/usr/bin/vendor_perl" "/usr/bin/core_perl" "/usr/lib/emacs/24.3/x86_64-unknown-linux-gnu" "/usr/share/git/remote-helpers")))
 '(fill-column 78)
 ...
 '(org-agenda-files (quote ("~/Dropbox/log.org" "~/Dropbox/personal.org" "~/Dropbox/Work/orgfiles")))
 ...
 '(sml/active-foreground-color "#eaeaea")
 '(sml/inactive-background-color "#00000")
 '(sml/inactive-foreground-color "#1d1f21")
 '(sml/name-width 75)
