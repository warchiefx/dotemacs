...
(defun sweyla882164 ()
  "Theme generated by Sweyla: http://sweyla.com/themes/seed/882164/"
  (interactive)
  (color-theme-install
   '(sweyla882164
     ...
     (font-lock-builtin-face ((t (:foreground "#BD7C61"))))
     (font-lock-function-name-face ((t (:foreground "#FFFF1C"))))
     (font-lock-variable-name-face ((t (:foreground "#FFED67"))))
     (font-lock-keyword-face ((t (:foreground "#0C99FA"))))
     (font-lock-string-face ((t (:foreground "#6A75AF"))))
     (font-lock-doc-string-face ((t (:foreground "#6A75AF"))))
     (font-lock-type-face ((t (:foreground "#CD8D7B"))))
     )))

(provide 'sweyla882164)

(defun sweyla934461 ()
  "Theme generated by Sweyla: http://sweyla.com/themes/seed/934461/"
  (interactive)
  (color-theme-install
   '(sweyla934461
     ...
     (font-lock-comment-face ((t (:foreground "#FFD000"))))
     (font-lock-constant-face ((t (:foreground "#FF981B"))))
     (font-lock-builtin-face ((t (:foreground "#56C400"))))
     (font-lock-function-name-face ((t (:foreground "#FF3A00"))))
     (font-lock-variable-name-face ((t (:foreground "#F87100"))))
     (font-lock-keyword-face ((t (:foreground "#F1AC00"))))
     (font-lock-string-face ((t (:foreground "#FF9F08"))))
     (font-lock-doc-string-face ((t (:foreground "#FF9F08"))))
     (font-lock-type-face ((t (:foreground "#D4BC42"))))
     )))

(provide 'sweyla934461)

;;(sweyla882164)

;; (add-to-list 'load-path (concat site-lisp-path "noctilux-theme"))

;; (when (locate-library "noctilux-theme")
;;   (load-library "noctilux-theme"))
